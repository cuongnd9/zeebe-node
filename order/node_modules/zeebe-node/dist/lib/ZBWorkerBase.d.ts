...
import { ZBClient } from '../zb/ZBClient';
...
export declare class ZBWorkerBase<WorkerInputVariables, CustomHeaderShape, WorkerOutputVariables> extends EventEmitter {
    ...
    private readied;
    private jobStreams;
    private restartPollingAfterStall?;
