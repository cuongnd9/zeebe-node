...
import { CreateWorkflowInstanceRequest, CreateWorkflowInstanceResponse, CreateWorkflowInstanceWithResultRequest, CreateWorkflowInstanceWithResultResponse, DeployWorkflowResponse, FailJobRequest, PublishMessageRequest, SetVariablesRequest, ThrowErrorRequest, TopologyResponse, UpdateJobRetriesRequest, WorkflowRequestObject } from './interfaces-grpc';
...
export declare type DeployWorkflowFiles = string | string[];
...
export declare type InputVariables = KeyedObject;
export declare type WorkflowVariables = KeyedObject;
export declare type OutputVariables = KeyedObject;
export declare type CustomHeaders = KeyedObject;
export declare type ZBWorkerTaskHandler<WorkerInputVariables = InputVariables, CustomHeaderShape = CustomHeaders, WorkerOutputVariables = OutputVariables> = (job: Readonly<Job<WorkerInputVariables, CustomHeaderShape>>, complete: CompleteFn<WorkerOutputVariables>, worker: ZBWorker<WorkerInputVariables, CustomHeaderShape, WorkerOutputVariables>) => void;
...
export declare type BatchedJob<Variables = KeyedObject, Headers = KeyedObject, Output = KeyedObject> = Job<Variables, Headers> & CompleteFn<Output>;
export declare type ZBBatchWorkerTaskHandler<V, H, O> = (jobs: Array<BatchedJob<V, H, O>>, worker: ZBBatchWorker<V, H, O>) => void;
